...
class Min(Beacon):
  ...
  def plot(self, axis):
    ...
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.001, self.pos[1]+0.1), fontsize=14)
    # elif self.ID == 4:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.2, self.pos[1]-0.4), fontsize=14)
    # elif self.ID == 5:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.001, self.pos[1]-0.65), fontsize=14)
    # elif self.ID == 6:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]-0.7, self.pos[1]-0.3), fontsize=14)
    # elif self.ID == 7:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]-0.6, self.pos[1]-0.2), fontsize=14)
    # elif self.ID == 8:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]-0.2, self.pos[1]+0.2), fontsize=14)
    # elif self.ID == 9:
    ...
    # elif self.ID == 16:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.2, self.pos[1]-0.5), fontsize=14)
    # elif self.ID == 17:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.1, self.pos[1]+0.003), fontsize=14)
    # elif self.ID == 18:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.1, self.pos[1]+0.003), fontsize=14)
    ...
    # elif self.ID == 23:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.001, self.pos[1]-0.8), fontsize=14)
    # elif self.ID == 24:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.2, self.pos[1]+0.003), fontsize=14)
    # elif self.ID == 25:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.1, self.pos[1]+0.1), fontsize=14)
    # elif self.ID == 26:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.1, self.pos[1]+0.2), fontsize=14)
    # elif self.ID == 27:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.2, self.pos[1]+0.003), fontsize=14)
    # elif self.ID == 28:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.4, self.pos[1]+0.003), fontsize=14)
    # elif self.ID == 29:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.001, self.pos[1]+0.2), fontsize=14)
    # elif self.ID == 30:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]-0.9, self.pos[1]-0.7), fontsize=14)
    # else:
    #   self.annotation = axis.annotate(self.ID, xy=(self.pos[0]+0.001, self.pos[1]+0.003), fontsize=14)
