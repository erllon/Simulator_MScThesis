...
class PotentialFieldsExplore(ExplorationStrategy):
    ...
    def get_exploration_velocity(self, MIN, beacons, ENV):
        ...
        F_att = PotentialFieldsExplore.get_attractive_force(self.__K_n, MIN)
        F_rep = PotentialFieldsExplore.get_repulsive_force(self.__K_n, self.__K_o, MIN, ENV)
